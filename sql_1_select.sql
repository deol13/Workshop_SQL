...
#
SELECT name, countrycode FROM city WHERE countrycode = 'tto';
#
...
#
SELECT * FROM country WHERE IsNull(indepyear) AND population > 1000000;
#
# 18: Get countries with a SurfaceArea below 10 and a defined LifeExpectancy
#
SELECT * FROM country WHERE surfacearea < 10 AND NOT IsNull(LifeExpectancy);
